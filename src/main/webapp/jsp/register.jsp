	...
	<div class="container">
		...
		<div class="well">
			<form class="form-horizontal" role="form">
				...
				<div class="form-group">
					<label for="input-zipCode" class="col-md-2 control-label">Code postal</label>
					<div class="col-md-3">
						<input type="text" name="zipCode" id="input-zipCode" maxlength="5" class="form-control" placeholder="code postal" title="code postal">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<input type="text" name="city" id="input-city" maxlength="5" class="form-control" placeholder="ville" title="ville">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<select class="form-control" id="input-country" name="country" title="pays">
							<option>1</option>
							<option>2</option>
							<option>3</option>
							<option>4</option>
